...
interface Props {
  value: FormPurchasesOrderProductInterface;
  selectedRow: string;
  onNotifyClick: (formOrderProduct: FormPurchasesOrderProductInterface) => void;
}
...
export const PurchasesOrderProductTableItem: FC<Props> = ({
  ...
  const [formOrderProduct, setFormOrderProduct] = useState<FormPurchasesOrderProductInterface>({ ...value });
