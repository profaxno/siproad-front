...
import { PurchasesOrderStatusEnum, PurchasesOrderStatusNameEnum, PurchasesActionEnum } from '../enums';
import { PurchasesOrderSearch, PurchasesOrderSearchTable, PurchasesOrderButtons, PurchasesOrderForm, PurchasesOrderTabs } from '../components';
import { AdminDocumentTypeProvider } from '../../../admin/documentTypes/context/AdminDocumentTypeProvider';
import { PurchasesPurchaseTypeProvider } from '../../purchaseTypes/context/PurchasesPurchaseTypeProvider';
...
export const PurchasesOrderPage: FC = () => {
  ...
  const { setActionList, isOpenFormSection, form, screenMessage, resetScreenMessage } = context;
  ...
  useEffect(() => {
    ...
    switch (form.status) {
      case PurchasesOrderStatusEnum.NEW:
        ...
        setActionList([PurchasesActionEnum.RETURN, PurchasesActionEnum.ORDER]);
        break;
      case PurchasesOrderStatusEnum.ORDER:
        ...
        setActionList([PurchasesActionEnum.RETURN_WITH_CONFIRM, PurchasesActionEnum.SAVE, PurchasesActionEnum.GENERATE_PDF, PurchasesActionEnum.DELETE]);
        break;
            ...
            <div className="col-sm-5 mb-3">  
              <div className="d-flex align-items-center">
                ...
                <h5 className="text-dark m-0">
                  {PurchasesOrderStatusNameEnum.ORDER} {form.code}
                </h5>
              </div>

              {isOpenOrderFormSection && (
                <div className="border rounded mt-2 p-3">
                  <PurchasesPurchaseTypeProvider>
                  <AdminDocumentTypeProvider>
                    <PurchasesOrderForm />
                  </AdminDocumentTypeProvider>
                  </PurchasesPurchaseTypeProvider>
                </div>
