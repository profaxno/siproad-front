...
export const ProductsProductSearch = () => {
  ...
  const handleInputChange = async(e) => {
    ...
    const productList = await findProducts(value)
    // alert(`handleInputChange: productList=(${JSON.stringify(productList.length)})${JSON.stringify(productList)}`);
    updateTable(productList, TableActionEnum.LOAD);
  }
